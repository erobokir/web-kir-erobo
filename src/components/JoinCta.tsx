      ...
      <div className="mx-auto max-w-5xl px-5 sm:px-8">
        <div className="hex-grid-overlay glass-panel relative overflow-hidden rounded-3xl px-6 py-12 text-center sm:px-12 sm:py-16 lg:px-16">
          ...
          <a
            ...
            className="group mt-8 inline-flex items-center gap-2 rounded-full bg-signal-violet px-8 py-4 text-sm font-semibold text-white shadow-glow transition-transform hover:-translate-y-0.5"
          >
            Daftar Sekarang
